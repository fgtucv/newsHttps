!function(){let e=document.querySelector(".news-list"),t=document.querySelector(".input");document.querySelector(".button").addEventListener("click",()=>{n().then(e=>{s(e.articles)})});let s=t=>{let s;e.innerHTML="",s="",s=t.map(e=>`<li class="news-list__item">
...
//# sourceMappingURL=index.e1589699.js.map
