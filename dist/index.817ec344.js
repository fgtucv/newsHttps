const e=document.querySelector(".news-list"),t=document.querySelector(".input");document.querySelector(".button").addEventListener("click",()=>{n().then(e=>{s(e.articles)})});const s=t=>{let s;e.innerHTML="",s="",s=t.map(e=>`<li class="news-list__item">
...
//# sourceMappingURL=index.817ec344.js.map
